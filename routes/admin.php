...
/* |-------------------------------------------------------------------------- | Admin Routes |-------------------------------------------------------------------------- | | Here is where you can register web routes for your application. These | routes are loaded by the RouteServiceProvider within a group which | contains the "admin" middleware group. Now create something great! | */
...
Route::prefix('/admin')->group(function () {
    ...
    Route::middleware(['auth.admin'])->group(function () {
        ...
        Route::get('setting/{type}', [SettingController::class, 'index'])->name('admin.setting');
        ...
        Route::group(['prefix' => 'role'], function () {
            ...
            Route::post('status', [RoleController::class, 'changeStatus'])->name('admin.role.change.status');
        ...
        Route::group(['prefix' => 'lead'], function () {
            ...
            Route::post('status', [LeadController::class, 'changeStatus'])->name('admin.lead.change.status');
        ...
        Route::group(['prefix'=>'report'],function(){
            ...
            Route::post('list/project_type', [ReportController::class, 'updateProjectType'])->name('admin.report.update.project_type');
        ...
        Route::group(['prefix'=>'project'],function(){
            ...
            // Route::get('list', [ProjectController::class, 'index'])->name('admin.client.list');
