        ...
        <tbody>
            @forelse ($bids as $key => $item)
                <tr>
                    ...
                    <td class="no-wrap text-center">{{ $item->job_title }}</td>
                    ...
                    <td class="no-wrap text-center">
                        <div class="table-actions d-flex align-items-center justify-content-center gap-3 fs-6">
                            <a href="{{ route('admin.bid.edit', ['id' => $item->id]) }}" class="text-warning"
                            data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><i class="fa-solid fa-eye"></i></a>
                        </div>
                    </td>
                    @if ($item->is_lead_converted)
                        <td class="no-wrap text-center">
                            <div class="table-actions d-flex align-items-center justify-content-center gap-3 fs-6">
                                <a href="{{ route('admin.lead.edit', ['id' => $item->lead->id ?? '']) }}"
                                    class="text-success" title="Edit"><i class="fa-solid fa-eye"></i></a>
                            </div>
                        </td>
                    @else
                        <td></td>
