                ...
                <div class="card-body">
                    <div class="p-4 border rounded">
                        <form action="{{ route('admin.client.update', ['id' => $client->id]) }}" method="post"
                            ...
                            @csrf
                            <div class="col-md-6">
                                <label for="validationServer01" class="form-label">Full name<span class="text-danger">*</span></label>
                                <input type="text" name="client_name" class="form-control" id="client_name"
                                    value="{{ $client->client_name }}" required placeholder="Enter Full Name" >
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="skype" value="{{ $client->skype }}"
                                    class="form-control" id="validationCustom03" >
                                <div class="invalid-feedback">Please provide your Skype ID.</div>
                                @if ($errors->has('skype'))
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="linkedin" value="{{ $client->linkedin }}"
                                    class="form-control" id="validationCustom03" >
                                <div class="invalid-feedback">Please provide your LinkedIn Id.</div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="other" value="{{ $client->other }}"
                                    class="form-control" id="validationCustom03" >
