        ...
        <div class="card-body">
            <form action="{{ route('admin.client.storeMerge') }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <label for="validationServer01" class="form-label">Client name</label>
                        <input type="text" name="client_name" class="form-control" id="client_name"
                            value="{{ $clients[0]->client_name ?? '' }}" placeholder="">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="mobile" class="form-control" id="mobile"
                            value="{{ $clients[0]->mobile ?? '' }}" placeholder="">
                        <div class="valid-feedback">Looks good!</div>
                    ...
                    <div class="col-md-4">
                        <label for="validationServer01" class="form-label">Email<span
                                class="text-danger">*</span></label>
                        <input type="email" name="email" class="form-control" id="email"
                            value="{{ $clients[0]->email ?? '' }}" placeholder="">
                        <div class="valid-feedback">Looks good!</div>
                        @if ($errors->has('email'))
                    ...
                    <div class="col-md-4">
                        <label for="validationServer01" class="form-label">Skype</label>
                        <input type="text" name="skype" class="form-control" id="skype"
                            value="{{ $clients[0]->skype ?? '' }}" placeholder="Enter skype">
                        <div class="valid-feedback">Looks good!</div>
                        @if ($errors->has('skype'))
                    ...
                    <div class="col-md-4">
                        <label for="validationServer01" class="form-label">Linkedin</label>
                        <input type="text" name="linkedin" class="form-control" id="linkedin"
                            value="{{ $clients[0]->linkedin ?? '' }}" placeholder="">
                        <div class="valid-feedback">Looks good!</div>
                    ...
                    <div class="col-md-4">
                        <label for="validationServer01" class="form-label">Other</label>
                        <input type="text" name="other" class="form-control" id="other"
                            value="{{ $clients[0]->other ?? '' }}" placeholder="">
                        <div class="valid-feedback">Looks good!</div>
                        @if ($errors->has('other'))
